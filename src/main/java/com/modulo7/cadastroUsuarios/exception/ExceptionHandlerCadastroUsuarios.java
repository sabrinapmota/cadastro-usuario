package com.modulo7.cadastroUsuarios.exception;
...
@ControllerAdvice
public class ExceptionHandlerCadastroUsuarios extends ResponseEntityExceptionHandler {
    @Autowired
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return handleExceptionInternal(ex, new com.modulo6.miniprojetoRecirend.DTO.MensagensErroDTO(mensagem), headers, HttpStatus.BAD_REQUEST, request);
    }
